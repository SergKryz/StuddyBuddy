...
function Task() {
    ...
    const [taskByName, setTaskByName] = useState([])
    const [taskDetail, setTaskDetail] = useState([])
    const { currentUser } = useAuth()
    const taskName = useRef()

    useEffect(() => {
        const taskResponse = getTaskByUserId(currentUser?.uid);
    ...
    const handleSearch = () => {
        const data = taskName.current.value;
        const taskResponse = getTaskbyName(data, currentUser?.uid);
        taskResponse.then((data) => {
            setTaskByName(data)
    ...
    return (
        <>
            ...
            <div className="container-fluid">
                ...
                <div className="row" style={{ justifyContent: 'space-around', marginBottom: '59px' }}>
                        ...
                        <div className="row my-3">
                            <div className="col-lg-12 d-flex " style={{ justifyContent: 'space-between' }}>
                                ...
                                <form class="form-inline my-2 my-lg-0 mx-auto">
                                    <input class="form-control-sm form-control mr-sm-2  search" type="search" placeholder="" aria-label="Search" ref={taskName} />
                            ...
                            <div className="col-lg-12">
                                <table class="table task-tab-table">
                                    ...
                                    <tbody className='task-tab-table-body'>
                                        {
                                            taskByName.todoList && taskByName.todoList.map((todo,index) => (
                                                <TodoTask todo={todo} index={index} showDetails={showDetails}/>
                                                ))
                                        }
                                ...
                                <div className="container-fluid task-detail-head">
                                    <div className="col-lg-12 d-flex " style={{ justifyContent: 'space-between' }}>
                                        ...
                                        <span className='text2'>
                                            {taskDetail.todoList && taskDetail.todoList[0].todoName}
                                        </span>
                                    </div>
                                </div>
                            </div>
                            <div className="row my-4">
                                <div className="container-fluid d-flex " style={{ justifyContent: 'space-between' }}>
                                    ...
                                    <div className="datebox d-flex align-items-center">
                                        ...
                                        <input type="date" defaultValue={taskDetail.todoList && taskDetail.todoList[0].deadline} style={{ border: 'none', borderRadius: '10px' }} />
                                    </div>
                            ...
                            <div className="row">
                                <div className="container-fluid">
                                    <div className="col-lg-12 d-flex justify-content-center">
                                        <textarea name="" id="" defaultValue={taskDetail.todoList && taskDetail.todoList[0].todoDescription} cols="30" rows="5" placeholder='Write your note here' ></textarea>
                                    </div>
                                </div>
                            </div>
                            <div className="row my-4 ">
